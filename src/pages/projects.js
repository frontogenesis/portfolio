            ...
            <section className='projects-container'>
                <div className='projects-row'>
                    <div className='projects-column card'>
                        ...
                        <div className='project-name'>South Carolina Emergency Information Network</div></a>
                    ...
                    <div className='projects-column card'>
                        ...
                        <div className='project-name'>Florida Public Radio Emergency Network</div></a>
                        <div className='project-description'>
                ...
                <div className='projects-row'>
                    <div className='projects-column card'>
                        ...
                        <div className='project-name'>WUFT Weather Hub</div></a>
                        <div className='project-description'>
                    ...
                    <div className='projects-column card'>
                        ...
                        <div className='project-name'>WeatherSTEM Module</div></a>
                        <div className='project-description'>
                ...
                <div className='projects-row'>
                    <div className='projects-column card'>
                        <a href='https://twitter.com/search?q=%22%40floridastorms%22%20%22tornado%20warning%22&src=typed_query' target='_blank' rel='noreferrer'>
                        <StaticImage 
                            src='../images/projects/twitter_auto_tor.png' 
                            alt='Social Automation' />
                        <div className='project-name'>Social Media Hazards Automation</div></a>
                        <div className='project-description'>
                    ...
                    <div className='projects-column card'>
                        ...
                        <span className='project-name'>Evacuation Zones Map</span>
                        <div className='project-description'>
                ...
                <div className='projects-row'>
                    <div className='projects-column card'>
                        ...
                        <div className='project-name'>FPREN Live Stream</div></a>
                        <div className='project-description'>
                    ...
                    <div className='projects-column card'>
                        ...
                        <div className='project-name'>Neural Network Text-to-Speech</div></a>
                        <div className='project-description'>
